...
def get_personality_messages(chat_data, num_messages=150):
    """
    Get a diverse sample of messages for personality/style reference.
    
    Args:
        chat_data: ChatData object with messages
        num_messages: Number of messages to sample (default 150)
...
def create_rag_prompt(selected_person, personality_messages, contextual_messages, using_fallback=False):
    """
...
def get_chatbot_response_rag(chat_data_id, user_input, user_api_key=None):
    ...
    3. Creates an enhanced prompt with relevant context
    4. Generates a response using GPT-4
    ...
    """
    try:
        print(f"\n[RAG] ===== Processing message for chat {chat_data_id} =====")
        ...
        # Generate response
        print("[RAG] Generating response with GPT-4...")
